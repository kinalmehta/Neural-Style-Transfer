...
parser.add_argument("-style_layer_weight", type=str, default="64,128,256,512,512")
...
def main():
    style_layer_weights = list(map(int, params.style_layer_weight.split(",")))
        ...
        if next_content_idx < len(content_layers) or next_style_idx < len(style_layers):
            ...
            if isinstance(layer, nn.ReLU):
                ...
                if layerList['R'][r] in style_layers:
                    ...
                    loss_module = StyleLoss(params.style_weight/style_layer_weights[next_style_idx]**2)
                    net.add_module(str(len(net)), loss_module)
                    style_losses.append(loss_module)
                    next_style_idx += 1
                r+=1
